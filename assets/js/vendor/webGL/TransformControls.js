...
THREE.TransformControlsGizmo = function () {
	...
	var gizmoMaterial = new THREE.MeshStandardMaterial({
		depthTest: false,
		depthWrite: false,
		transparent: true,
	...
	var texture = diffuse.load('texture/sprite-move.png');
	// var matMoveAxis = new THREE.MeshStandardMaterial({
	// 	map : texture,
	// 	depthTest: false,
	// 	depthWrite: false,
	// 	linewidth: 1,
	...
	matMagentaTransparent.map = null;
...
THREE.TransformControlsPlane = function () {
	...
	THREE.Mesh.call( this,
		...
		new THREE.MeshBasicMaterial( { visible: false, wireframe: true, side: THREE.DoubleSide, transparent: true, opacity: 0.0 } )
	);
